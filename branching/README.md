...
* [ ] Analyze the code and try to understand what it does.
* [ ] Check the reports to see how the performance and resource utilization changes with different versions of the function.
* [ ] Try with and without the `#pragma HLS pipeline II=1` and check the reports to see how it changes the performance and resource utilization.